-- Re-declares save_pair_profiles (migration 076/078/080/082/084/086/088/
-- 092) to also write thumbnail_image_url (migration 101) — same
...
begin
  ...
  loop
    insert into pair_profiles (
      ...
      pair_image_url, thumbnail_image_url, character_backdrop_url,
      illustration_source, illustration_source_font, illustration_source_color,
      world, swap_thumbnail_names,
      ...
      profile_rec->>'pair_image_url', profile_rec->>'thumbnail_image_url', profile_rec->>'character_backdrop_url',
      profile_rec->>'illustration_source', profile_rec->>'illustration_source_font', profile_rec->>'illustration_source_color',
      profile_rec->>'world', (profile_rec->>'swap_thumbnail_names')::boolean,
