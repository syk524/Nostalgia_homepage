-- Re-declares get_public_pair_grid (migration 052) to also return world
-- (migration 087), so the grid card can show it without needing signed-in
-- read access to pair_profiles directly.
