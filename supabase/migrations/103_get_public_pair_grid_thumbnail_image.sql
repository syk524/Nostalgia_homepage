-- Re-declares get_public_pair_grid (migration 052/089/093) to also return
-- thumbnail_image_url (migration 101), so a guest's own grid card can
-- fall back to it too, same reasoning as swap_thumbnail_names before it.
  ...
  select jsonb_build_object(
    ...
    'pair_profiles', jsonb_build_array(
      jsonb_build_object(
        ...
        'thumbnail_image_url', pp.thumbnail_image_url,
