...
export default function RegisterPage() {
  ...
  return (
    <AuthShell tagline="Start your gallery">
      <h2 className="noir-accent-color text-xl mb-6 text-ink">Sign Up</h2>

      <form action={action} className="space-y-4">
        <div>
          <label className="noir-accent-color label" htmlFor="username">Username</label>
          <input id="username" name="username" type="text" required minLength={3}
            className="input" placeholder="username" autoComplete="username" />
        </div>

        <div>
          <label className="noir-accent-color label" htmlFor="display_name">Nickname</label>
          <input id="display_name" name="display_name" type="text"
            className="input" placeholder="Optional — shown to others" />
        </div>

        <div>
          <label className="noir-accent-color label" htmlFor="password">Password</label>
