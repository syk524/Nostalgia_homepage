...
export default async function CharacterArchivePage() {
  ...
  type PrimaryProfileSummary = Pick<PairProfile, 'title' | 'title_font' | 'pair_image_url' | 'thumbnail_image_url' | 'illustration_source' | 'world' | 'swap_thumbnail_names' | 'background_url'> & { profile_characters: Pick<ProfileCharacter, 'name' | 'name_color' | 'name_font' | 'slot'>[] }
